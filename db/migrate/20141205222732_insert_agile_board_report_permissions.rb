class InsertAgileBoardReportPermissions < ActiveRecord::Migration
  def up
    ...
    Permission.create(controller: 'Sprints', action: 'restore', name: 'Restore sprint', is_locked: true)
  ...
  def down
    ...
    Permission.delete_all(controller: 'Sprints', action: 'restore', name: 'Restore sprint')
